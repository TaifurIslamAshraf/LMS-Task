...
const resetPassSchema = z
  ...
  type RPFormValues = z.infer<typeof resetPassSchema>;
          ...
          <Form {...form}>
            ...
            >
              <FormField
                ...
                render={({ field }:{ field: ControllerRenderProps<RPFormValues, "newPassword"> }) => (
                  <FormItem>
              ...
              <FormField
                ...
                control={form.control}
                render={({ field }:{ field: ControllerRenderProps<RPFormValues, "confirmPassword"> }) => (
                  <FormItem>
