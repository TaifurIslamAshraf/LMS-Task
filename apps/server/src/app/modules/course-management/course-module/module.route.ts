...
router.get("/:id", validateRequest(getModuleByIdSchema), getModuleById);
router.get("/course/:courseId", validateRequest(getModulesByCourseIdSchema), getModulesByCourseId);
